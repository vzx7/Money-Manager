...
const HomePage = () => {
    ...
    return (
        <div>
            {currentUser ? (
                <><div className="title">Главная страница</div><div className="grid grid-cols-3 justify-items-center items-center gap-4 text-center statistic-info py-5">
                    <p className="text-lg">
                ...
                </div><div className="flex flex-col py-12">
